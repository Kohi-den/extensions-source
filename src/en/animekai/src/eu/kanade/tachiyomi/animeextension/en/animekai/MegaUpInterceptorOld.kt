...
class MegaUpInterceptorOld(private val client: OkHttpClient) {

    private val context: Application by injectLazy()
    private val handler by lazy { Handler(Looper.getMainLooper()) }
    private val tag = "AnimeKaiExtractor"
    ...
    fun extractVideosFromUrl(
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun shouldInterceptRequest(
                ...
                Log.d(tag, "Intercepted request: $reqUrl")
                if (reqUrl.endsWith(".m3u8")) {
                    Log.d(tag, "Found .m3u8 request: $reqUrl")
                    // If master playlist already found, ignore further .m3u8 requests
                    if (masterPlaylistFound) {
                        Log.d(tag, "Master playlist already found, skipping: $reqUrl")
                    ...
                    try {
                        ...
                        Log.d(tag, "Playlist content for $reqUrl:\n$playlistContent")
                            ...
                            for (i in lines.indices) {
                                ...
                                if (line.startsWith("#EXT-X-STREAM-INF")) {
                                    ...
                                    if (!streamUrl.isNullOrEmpty() && currentQuality != null) {
                                        ...
                                        Log.d(tag, "Adding video: $absoluteUrl ($currentQuality)")
            ...
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                handler.postDelayed({
                    Log.d(tag, "Final videoResults: $videoResults")
                    Log.d(tag, "Final subtitleResults: $subtitleResults")
